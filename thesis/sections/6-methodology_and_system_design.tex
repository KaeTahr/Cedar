...
is accessed by \texttt{(unint32_tdata[w] >> (k * 8)) \& 0xFF}. Multi-byte
...
Nested \texttt{recoerd { ... } @ off} are \textbf{flattened} with \textbf{_}
...
\begin{itemize}
    ...
    \texttt{d_get_name__0}...\texttt{d_get_name__15}. Each reads/writes
...
\begin{enumerate}
    \item \texttt{name: U8[16] @ 0B} \rightarrow \texttt{data[0]..data[3]}, lanesS 0, 8, 16, 24 per
...
\begin{enumerate}
    ...
    \item Pointers/boxed fields, tagged unions, and sub-type bit-fields are out of scope in this prototype.
\end{enumerate}
...
Cedar prototype, based on the grammar and pipeline described in
...
prototype language and compiler for declarative specification of C data
