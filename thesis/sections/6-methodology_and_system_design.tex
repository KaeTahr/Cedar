...
Cedar achieves this by introducing a small external language
...
otherwise be silently mishandled by compiler-specific padding or unordered
...
Arrays are represented as repeated layouts of a uniform element type.
...
Its syntax follows C's lexical conventions but introduces
...
end simple arrays—that enable programmers to express physical data
